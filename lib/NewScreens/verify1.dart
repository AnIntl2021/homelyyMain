...
class Verifynewone extends StatefulWidget {
  const Verifynewone({Key key}) : super(key: key);

  @override
  _VerifynewoneState createState() => _VerifynewoneState();
}

class _VerifynewoneState extends State<Verifynewone> {
  @override
