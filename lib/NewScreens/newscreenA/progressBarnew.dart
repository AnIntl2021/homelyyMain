...
class ProgressBarnew extends StatefulWidget {
  final String id,status;
  ProgressBarnew({Key key, this.id, this.status}) : super(key: key);

  _ProgressBarState createState() => _ProgressBarState();
}

class _ProgressBarState extends State<ProgressBarnew>
{
  ...
  Widget build(BuildContext context) {
    return AnimatedBar(status: widget.status,);
  }
}
...
class AnimatedBar extends StatefulWidget {
  ...
  const AnimatedBar({Key key, this.status}) : super(key: key);
