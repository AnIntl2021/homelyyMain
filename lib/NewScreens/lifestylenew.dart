...
//             child: ClipRRect(
//                 child: Image.asset(
//                   "lib/NewScreens/lifestylenew.dart",
//                   fit: BoxFit.fill,
//                 )),
//           ),),
//             pinned: true,
//             expandedHeight: 175,
//
//             leading: Image.asset("assets/arrow.pngz"),
//             actions: [Row(
//               children: [Padding(
...
//             child: Container(
//               child: Row(children: [
//                 ClipRRect(child: Image.asset("assets/star.png")),SizedBox(width: 10,),Text("4.6",style: TextStyle(fontSize: 15)),
...
//
//               child: Row(children: [
//                 ClipRRect(child: Image.asset("assets/location.png")),SizedBox(width: 10,),Text("2435, Kings street, Ontario (K27G3V)",style: TextStyle(fontSize: 15)),
//               ],),
//             ),
//           ),SizedBox(height: 10,),
//           Padding(
...
//                   children: [
//                     ClipRRect(child: Image.asset("assets/menuicon.png"))
//                   ],
//                 ),
//               ),
//             ),
