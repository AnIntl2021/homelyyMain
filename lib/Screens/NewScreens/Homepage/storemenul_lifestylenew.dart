...
class StoreMenuLifeStyle extends StatefulWidget {
  @override
  State<StoreMenuLifeStyle> createState() => _StoreMenuLifeStyleState();
}

class _StoreMenuLifeStyleState extends State<StoreMenuLifeStyle> {
  int _counter = 0;
  increment(){
    setState(() {
      _counter++;
      ...
      body:CustomScrollView(
        ...
        slivers: [
          SliverAppBar(
            ...
            child: ClipRRect(
                child: Image.asset(
                  "assets/lifestyle screen og.png",
                  fit: BoxFit.fill,
                )),
          ),),
            pinned: true,
          ...
          itemBuilder: (context,index){
            return Column(
              children: [SizedBox(height: 10,),
                buildProductCard("  Silk Shirt(3-pack)"),SizedBox(height: 10,)
        ...
        children: [Container
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  Image.asset("assets/Rectangle 66.png"),Text(title,style: TextStyle(fontSize: 12),),SizedBox(width:70,),
                  Container(
                    height: 20,
                    width: 70,
                    decoration: BoxDecoration(
                ...
                Row(children: [
                  Text("Features: button-front dress shirt, solid  \ncolor. Usually with a jacket, tie and a suit \nor formalwear, but this shirts are also  \nworn casually too. ",style: TextStyle(fontSize: 9)),
                  Padding(
