...
class ItemList extends StatefulWidget {
  ...
  const ItemList({
     Key key,
     this.streamTitle,
     this.callback,  this.id,  this.shopname,
  }) : super(key: key);
...
class _ItemListState extends State<ItemList> {
  ...
  Widget build(BuildContext context) {
    ...
    totalorders : 1,
    price: "100",
    recipe: "Mayo,Cheese,Patty,Mayo,Cheese,Patty", stock: true,
    tagVisibility: true, img: "https://firebasestorage.googleapis.com/v0/b/food-app-b497c.appspot.com/o/pizza_combo.webp?alt=media&token=ab1aa2b7-d1f3-4c30-8015-9c8d70161d37", key: Key("prodlistcard"),
    press: (){}, discount:  (int.parse("100") - int.parse("80")).toString(),
    discountVisibility: true ,
    uid: "uid", shopName: widget.shopname, cutprice: "80",
