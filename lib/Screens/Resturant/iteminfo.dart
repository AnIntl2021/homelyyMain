...
class _ItemInfoState extends State<ItemInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: homeAppBar(context, widget.title,
          widget.uid!.replaceAll("+", "").removeAllWhitespace, "Product"),
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            TitlePriceRating(
                name: widget.title,
                numOfReviews:
                    double.parse(widget.rating!).toStringAsPrecision(1),
  ...
  Row shopeName({required List<dynamic> name}) {
    return Row(
      children: <Widget>[
        Icon(
          Icons.location_on,
                                  ...
                                  widget.uid == 'Guest'
                                      ? FutureBuilder(
                                          ...
                                          builder: (context, snapshot1) {
                                            ...
                                            SharedPreferences usermodel =
                                                (snapshot1.requireData
                                                    as List)[1];

                                            var symbol =
                                                usermodel.get('gsymbol');

                                            List<ProductModel> foodList =
                                                (snapshot1.requireData
                                                    as List)[0];
                                            print(
                                                "foodList lenght = ${foodList}");
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return ProductListCard(
                                                                ...
                                                                tagVisibility:
                                                                    true,
                                                                img:
                                                                    "${imageURL}products/${foodList[index].image}",
                                                                press: () {},
                                                                discount: (int.parse(
                                                                            "100") -
                                                                        int
                                      ...
                                      : FutureBuilder(
                                          ...
                                          builder: (context, snapshot1) {
                                            ...
                                            UserModel usermodel = UserModel()
                                                .fromJson(jsonDecode((snapshot1
                                                    .requireData as List)[1]));
