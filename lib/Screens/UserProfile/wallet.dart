...
class _UserWalletState extends State<UserWallet> {
  ...
  Widget build(BuildContext context) {
    void openCheckout(
        {String? phone, String? id, String? email, required int amount}) async {
      print("amount = $amount");
    ...
    Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
      Fluttertoast.showToast(
          ...
          .then((value) async => {
                await AllApi()
                    .updateWallet(widget.id, enteredAmount.toString())
                    .then((value) async {})
              });
    }
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            UserModel usersList = UserModel()
                .fromJson(jsonDecode(snapshot.requireData.toString()));
